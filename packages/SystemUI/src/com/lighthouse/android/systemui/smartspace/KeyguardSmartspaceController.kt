package com.lighthouse.android.systemui.smartspace
...
class KeyguardSmartspaceController @Inject constructor(
    ...
    init {
        if (!featureFlags.isSmartspaceEnabled()) {
            context.packageManager.setComponentEnabledSetting(ComponentName("com.android.systemui", "com.lighthouse.android.systemui.keyguard.KeyguardSliceProviderLighthouse"), 1, 1)
        } else {
