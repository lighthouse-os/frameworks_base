...
public class LighthouseKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    public Slice onBindSlice(Uri uri) {
        ...
        Trace.beginSection("LighthouseKeyguardSliceProvider#onBindSlice");
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<LighthouseKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(LighthouseKeyguardSliceProvider lighthouseKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(lighthouseKeyguardSliceProvider);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = lighthouseKeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            LighthouseKeyguardSliceProvider lighthouseKeyguardSliceProvider;
            synchronized (this) {
                this.mWeatherCard.setIcon(bitmap);
                lighthouseKeyguardSliceProvider = this.mProviderReference.get();
            }
            if (lighthouseKeyguardSliceProvider != null) {
                lighthouseKeyguardSliceProvider.notifyChange();
            }
        }
