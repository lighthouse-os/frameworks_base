package com.lighthouse.android.systemui.keyguard;
...
public class KeyguardSliceProviderLighthouse extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderLighthouse> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderLighthouse keyguardSliceProviderLighthouse, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderLighthouse);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderLighthouse.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderLighthouse keyguardSliceProviderLighthouse;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderLighthouse = (KeyguardSliceProviderLighthouse) mProviderReference.get();
            }
            if (keyguardSliceProviderLighthouse != null) {
                keyguardSliceProviderLighthouse.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderLighthouse#onBindSlice");
        Slice slice;
